...
class VideoManager: ObservableObject {
    ...
    func findVideos(topic: Query) async {
        do {
            ...
            urlRequest.setValue("563492ad6f917000010000018a924efa901d4a889a347b9530b37760", forHTTPHeaderField: "Authorization")
           ...
           let (data, response ) = try await URLSession.shared.data(for: urlRequest)
            ...
            print("Error fetching data from Pexles: \(error)")
        }
    }
}
